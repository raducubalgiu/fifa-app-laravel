<x-admin-master>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Editeaza meciul #{{$game->id}}</h6>
        </div>

        <div class="card-body">
            <form method="post" action="{{route('championship.games.update', $game->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
